...
static const char *fonts[]          = { "Inter Nerd Font:size=12", "Noto Color Emoji:size=12" };
static const char dmenufont[]       = "Inter Nerd Font:size=12";
